...
| **projectSettings** | <HelpLink href="#api-basics/types">Map</HelpLink>          | No       | Project settings that will be applied to deployment. It is required for the first deployment of a project and will be saved for any following deployment.                                                                       |
...
| Key                 | <HelpLink href="#api-basics/types" hasIcon>Type</HelpLink> | Required | Description                                                                        |
| ------------------- | ---------------------------------------------------------- | -------- | ---------------------------------------------------------------------------------- |
| **framework**       | <HelpLink href="#api-basics/types">Enum</HelpLink>         | No       | Must either be a framework slug from `@now/frameworks` or `null`.                  |
...
| **rootDirectory**   | <HelpLink href="#api-basics/types">String</HelpLink>       | No       | The name of a directory or relative path to the source code of your project.       |

If the `publicSource` property is not set for the first deployment, the API will return an error containing information about the detected framework from `@now/frameworks`, which can be used for the next request to complete the deployment.
...
<Note>
  The query paramter `?skipAutoDetectionConfirmation=1` can be appened to the
  deployments API URL to skip this confirmation error.
</Note>
